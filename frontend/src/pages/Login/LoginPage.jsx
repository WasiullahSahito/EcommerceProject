            ...
            <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md mx-auto">
                ...
                <form className="space-y-6">
                    ...
                    <div className="text-right">
                        <a href="#" className="text-sm font-medium text-gray-600 hover:text-primeColor">Forgot Password?</a>
                    </div>
                ...
                <p className="text-center text-gray-600 mt-6 text-sm">
                    Not Registered?{' '}
                    <Link to="/register" className="text-primeColor hover:underline font-semibold">Sign Up</Link>
                </p>
