            ...
            <div className="container mx-auto px-4 pt-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10">
                    <div>
                        ...
                        <p className="mb-2"><a href="mailto:sales@yourcompany.com" className="hover:text-primeColor transition-colors">sales@yourcompany.com</a></p>
                    ...
                    <div>
                        ...
                        <input type="email" placeholder="Your Email Address" className="w-full border border-gray-300 p-2 rounded-md mb-3 focus:outline-none focus:ring-1 focus:ring-primeColor" />
